...
function ts_parser_set_language(self, language)
    ccall((:ts_parser_set_language, libtreesitter), Bool, (Ptr{TSParser}, Ptr{TSLanguage}), self, language)
end
...
function ts_parser_set_included_ranges(self, ranges, length)
    ccall((:ts_parser_set_included_ranges, libtreesitter), Bool, (Ptr{TSParser}, Ptr{TSRange}, UInt32), self, ranges, length)
end
...
function ts_parser_set_cancellation_flag(self, flag)
    ccall((:ts_parser_set_cancellation_flag, libtreesitter), Cvoid, (Ptr{TSParser}, Ptr{Csize_t}), self, flag)
end

function ts_parser_cancellation_flag(self)
    ccall((:ts_parser_cancellation_flag, libtreesitter), Ptr{Csize_t}, (Ptr{TSParser},), self)
end
...
function ts_node_named_child(arg1, arg2)
    ccall((:ts_node_named_child, libtreesitter), TSNode, (TSNode, UInt32), arg1, arg2)
end
...
function ts_node_child_by_field_id(arg1, arg2)
    ccall((:ts_node_child_by_field_id, libtreesitter), TSNode, (TSNode, TSFieldId), arg1, arg2)
end
...
function ts_node_first_child_for_byte(arg1, arg2)
    ccall((:ts_node_first_child_for_byte, libtreesitter), TSNode, (TSNode, UInt32), arg1, arg2)
end

function ts_node_first_named_child_for_byte(arg1, arg2)
    ccall((:ts_node_first_named_child_for_byte, libtreesitter), TSNode, (TSNode, UInt32), arg1, arg2)
end

function ts_node_descendant_for_byte_range(arg1, arg2, arg3)
    ccall((:ts_node_descendant_for_byte_range, libtreesitter), TSNode, (TSNode, UInt32, UInt32), arg1, arg2, arg3)
end

function ts_node_descendant_for_point_range(arg1, arg2, arg3)
    ccall((:ts_node_descendant_for_point_range, libtreesitter), TSNode, (TSNode, TSPoint, TSPoint), arg1, arg2, arg3)
end

function ts_node_named_descendant_for_byte_range(arg1, arg2, arg3)
    ccall((:ts_node_named_descendant_for_byte_range, libtreesitter), TSNode, (TSNode, UInt32, UInt32), arg1, arg2, arg3)
end

function ts_node_named_descendant_for_point_range(arg1, arg2, arg3)
    ccall((:ts_node_named_descendant_for_point_range, libtreesitter), TSNode, (TSNode, TSPoint, TSPoint), arg1, arg2, arg3)
end
...
function ts_tree_cursor_delete(arg1)
    ccall((:ts_tree_cursor_delete, libtreesitter), Cvoid, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_reset(arg1, arg2)
    ccall((:ts_tree_cursor_reset, libtreesitter), Cvoid, (Ptr{TSTreeCursor}, TSNode), arg1, arg2)
end

function ts_tree_cursor_current_node(arg1)
    ccall((:ts_tree_cursor_current_node, libtreesitter), TSNode, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_current_field_name(arg1)
    ccall((:ts_tree_cursor_current_field_name, libtreesitter), Cstring, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_current_field_id(arg1)
    ccall((:ts_tree_cursor_current_field_id, libtreesitter), TSFieldId, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_goto_parent(arg1)
    ccall((:ts_tree_cursor_goto_parent, libtreesitter), Bool, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_goto_next_sibling(arg1)
    ccall((:ts_tree_cursor_goto_next_sibling, libtreesitter), Bool, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_goto_first_child(arg1)
    ccall((:ts_tree_cursor_goto_first_child, libtreesitter), Bool, (Ptr{TSTreeCursor},), arg1)
end

function ts_tree_cursor_goto_first_child_for_byte(arg1, arg2)
    ccall((:ts_tree_cursor_goto_first_child_for_byte, libtreesitter), Int64, (Ptr{TSTreeCursor}, UInt32), arg1, arg2)
end

function ts_tree_cursor_copy(arg1)
    ccall((:ts_tree_cursor_copy, libtreesitter), TSTreeCursor, (Ptr{TSTreeCursor},), arg1)
end
...
function ts_query_pattern_count(arg1)
    ccall((:ts_query_pattern_count, libtreesitter), UInt32, (Ptr{TSQuery},), arg1)
end

function ts_query_capture_count(arg1)
    ccall((:ts_query_capture_count, libtreesitter), UInt32, (Ptr{TSQuery},), arg1)
end

function ts_query_string_count(arg1)
    ccall((:ts_query_string_count, libtreesitter), UInt32, (Ptr{TSQuery},), arg1)
end

function ts_query_start_byte_for_pattern(arg1, arg2)
    ccall((:ts_query_start_byte_for_pattern, libtreesitter), UInt32, (Ptr{TSQuery}, UInt32), arg1, arg2)
end

function ts_query_predicates_for_pattern(self, pattern_index, length)
    ccall((:ts_query_predicates_for_pattern, libtreesitter), Ptr{TSQueryPredicateStep}, (Ptr{TSQuery}, UInt32, Ptr{UInt32}), self, pattern_index, length)
end

function ts_query_capture_name_for_id(arg1, id, length)
    ccall((:ts_query_capture_name_for_id, libtreesitter), Cstring, (Ptr{TSQuery}, UInt32, Ptr{UInt32}), arg1, id, length)
end

function ts_query_string_value_for_id(arg1, id, length)
    ccall((:ts_query_string_value_for_id, libtreesitter), Cstring, (Ptr{TSQuery}, UInt32, Ptr{UInt32}), arg1, id, length)
end
...
function ts_query_cursor_delete(arg1)
    ccall((:ts_query_cursor_delete, libtreesitter), Cvoid, (Ptr{TSQueryCursor},), arg1)
end

function ts_query_cursor_exec(arg1, arg2, arg3)
    ccall((:ts_query_cursor_exec, libtreesitter), Cvoid, (Ptr{TSQueryCursor}, Ptr{TSQuery}, TSNode), arg1, arg2, arg3)
end
...
function ts_query_cursor_next_match(arg1, match)
    ccall((:ts_query_cursor_next_match, libtreesitter), Bool, (Ptr{TSQueryCursor}, Ptr{TSQueryMatch}), arg1, match)
end
...
function ts_query_cursor_next_capture(arg1, match, capture_index)
    ccall((:ts_query_cursor_next_capture, libtreesitter), Bool, (Ptr{TSQueryCursor}, Ptr{TSQueryMatch}, Ptr{UInt32}), arg1, match, capture_index)
end

function ts_language_symbol_count(arg1)
    ccall((:ts_language_symbol_count, libtreesitter), UInt32, (Ptr{TSLanguage},), arg1)
end

function ts_language_symbol_name(arg1, arg2)
    ccall((:ts_language_symbol_name, libtreesitter), Cstring, (Ptr{TSLanguage}, TSSymbol), arg1, arg2)
end

function ts_language_symbol_for_name(self, string, length, is_named)
    ccall((:ts_language_symbol_for_name, libtreesitter), TSSymbol, (Ptr{TSLanguage}, Cstring, UInt32, Bool), self, string, length, is_named)
end

function ts_language_field_count(arg1)
    ccall((:ts_language_field_count, libtreesitter), UInt32, (Ptr{TSLanguage},), arg1)
end

function ts_language_field_name_for_id(arg1, arg2)
    ccall((:ts_language_field_name_for_id, libtreesitter), Cstring, (Ptr{TSLanguage}, TSFieldId), arg1, arg2)
end

function ts_language_field_id_for_name(arg1, arg2, arg3)
    ccall((:ts_language_field_id_for_name, libtreesitter), TSFieldId, (Ptr{TSLanguage}, Cstring, UInt32), arg1, arg2, arg3)
end

function ts_language_symbol_type(arg1, arg2)
    ccall((:ts_language_symbol_type, libtreesitter), TSSymbolType, (Ptr{TSLanguage}, TSSymbol), arg1, arg2)
end
